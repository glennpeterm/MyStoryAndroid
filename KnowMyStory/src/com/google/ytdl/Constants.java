...
public class Constants {
    ...
    public static final String UPLOAD_PLAYLIST = "PLAO50XcCvFizIYHISwCWnNduzKe6itwSh";
    public static final String APP_NAME = "ytd-android";
    public static int UPLOAD_YOUTUBE_PROGRESS = 0;
    public static String UPLOAD_FAILED = "failed";
    public static String UPLOAD_SUCCESS = "success";
    public static String YOUTUBE_PRIVACY_STATUS = "unlisted";
}
